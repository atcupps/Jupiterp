...
>
	<div class="mx-auto flex w-full max-w-6xl flex-col gap-4">
		...
		<section
			class="flex flex-col gap-4 rounded-md border border-outlineLight p-4 dark:border-outlineDark"
		>
				...
				{:else if requiresTwoMajors}
					<div class="flex flex-col gap-2 lg:col-span-2">
						...
						{#if selectingTwoMajors}
							<div
								class="max-h-44 overflow-y-auto rounded-md border border-outlineLight p-2 dark:border-outlineDark"
							>
								{#each UMD_MAJORS as major}
						...
						{:else}
							<div class="rounded-md border border-outlineLight p-3 dark:border-outlineDark">
								...
								<button
									class="mt-2 rounded-md border border-outlineLight px-3 py-1 text-sm hover:bg-hoverLight dark:border-outlineDark dark:hover:bg-hoverDark"
			...
			<div class="relative flex flex-col gap-2">
				...
				<div class="flex flex-wrap gap-2">
					...
					{#each selectedMinors as minor}
						<span
							class="inline-flex items-center gap-2 rounded-full border border-outlineLight px-3 py-1 text-xs dark:border-outlineDark"
						>
							{minor}
							<button
								class="rounded-sm text-sm leading-none hover:text-orange focus:outline-none focus:ring"
				...
				{#if minorsOpen}
					<div
						class="max-h-52 overflow-y-auto rounded-md border border-outlineLight
                                bg-bgLight shadow-lg dark:border-outlineDark dark:bg-bgDark"
					>
						...
						{#each filteredMinors as minor}
							<button
								class="w-full px-2 py-1 text-left text-sm hover:bg-hoverLight dark:hover:bg-hoverDark"
								on:click={() => {
									addMinor(minor);
								}}
							>
		...
		<section class="grid grid-cols-1 gap-4 xl:grid-cols-2">
			<div class="rounded-md border border-outlineLight p-4 dark:border-outlineDark">
