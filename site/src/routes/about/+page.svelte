...
<main>
  <article class="custom-scrollbar fixed bottom-0 top-12 overflow-y-auto px-4 py-2">
    ...
    <p class={pClasses}>
      ...
      students at UMD, because we know that students here know best what they need; that's why Jupiterp is also
      completely open-source, so that students can contribute to the project and make it better for both themselves and
      everyone else.
    </p>
    <p class={pClasses}>
    ...
    <p class={pClasses}>
      ...
      are gathered from the PlanetTerp API. Grade data is obtained from the University of Maryland via public records
      request.
    </p>
