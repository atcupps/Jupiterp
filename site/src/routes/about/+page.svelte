...
<div class="custom-scrollbar fixed bottom-0 top-12 overflow-y-auto px-4 py-2">
  ...
  <p class={pClasses}>
    ...
    open-source, so that students can contribute to the project and make it better for both themselves and everyone
    else.
  </p>
  <p class={pClasses}>
    Jupiterp is currently in beta phase - there may be issues. We are working to set up a system to report bugs; in the
  ...
  <p class={pClasses}>
    ...
    students to visit PlanetTerp and read reviews to get a better understanding of a professor's teaching style and the
    student experience in their classes.
  </p>
  ...
  <p class={pClasses}>
    All course information is taken directly from the Testudo Schedule of Classes. Instructor information and reviews
    are gathered from the PlanetTerp API.
  </p>
