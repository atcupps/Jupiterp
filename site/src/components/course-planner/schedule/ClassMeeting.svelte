...
<button
	class="absolute flex w-full flex-col justify-center
        justify-items-center overflow-hidden whitespace-normal break-words rounded-lg
    border border-outlineLight pb-1 text-black
    shadow-sm dark:border-outlineDark dark:text-white"
	bind:this={elt}
