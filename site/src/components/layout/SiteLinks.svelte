...
<div class="hidden grow justify-end self-center lg:flex">
	<NavBarElement link={`${base}/`} text="Course Planner" isOnPage={currentPage == '/'} />
	<NavBarElement link={`${base}/gen-eds`} text="Gen Eds" isOnPage={currentPage == '/gen-eds'} />
	<NavBarElement
		link={`${base}/major-minor-requirements`}
		text="Major/Minor Requirements"
		isOnPage={currentPage == '/major-minor-requirements'}
	/>
	<NavBarElement link={`${base}/friends`} text="Friends" isOnPage={currentPage == '/friends'} />
	<NavBarElement link={`${base}/profile`} text="Profile" isOnPage={currentPage == '/profile'} />
...
>
	...
	<div class="my-2 w-full text-lg">
		<NavBarElement link={`${base}/terms-of-use`} text="Terms of Use" fullWidth={true} />
	</div>
	<div class="my-2 w-full text-lg">
		<NavBarElement link={`${base}/changelog`} text="Changelog" fullWidth={true} />
	</div>
</div>
