...
export interface PtGradesRecord {
	...
	/** e.g. '201801'; YYYY01 Spring, YYYY05 Summer, YYYY08 Fall, YYYY12
	 * Winter */
	semester: string;
	section: string;
	'A+': number;
...
export interface GradeDistribution {
	...
	/** All letter grades + F + W; 'Other' is excluded, matching
	 * PlanetTerp's GPA denominator */
