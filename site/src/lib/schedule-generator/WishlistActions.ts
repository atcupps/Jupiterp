 ...
 */
export function addRequirement(reqs: GeneratorRequirement[], course: Course): GeneratorRequirement[] {
...
export function removeRequirement(reqs: GeneratorRequirement[], courseCode: string): GeneratorRequirement[] {
