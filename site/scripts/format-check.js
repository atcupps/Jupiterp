...
//       const effectiveLimit = extraCharsAllowed === Infinity ? Infinity : MAX_LINE_LENGTH + extraCharsAllowed;
...
function main() {
  ...
  if (totalErrors === 0) {
    ...
    console.log(`\x1b[31m✗ Found ${totalErrors} error(s) in ` + `${filesWithErrors} file(s)\x1b[0m`);
